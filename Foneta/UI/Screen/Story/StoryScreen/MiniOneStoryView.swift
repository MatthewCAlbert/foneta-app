            ...
            switch(page) {
                case 1:
                    SceneWithCaptionView(
                        nextScene: AnyView(mainStoryLane[nextScreenId].body), backgroundImage: "Screen2-Bg", captionText: "Rahmat adalah seorang petualang pemberani. Hari ini, Rahmat menjelajahi pantai tersembunyi. Pantainya indah sekali!",
                    ...
                    SceneWithCaptionView(
                        ...
                        nextScene: AnyView(mainStoryLane[nextScreenId].body), backgroundImage: "Screen3-Bg", captionText: "Di pantai, rahmat disambut oleh Kepi si Kepiting. Kepi sangat senang bertemu Rahmat si petualang pemberani!", captionVoiceover: .screen3, childObject: AnyView(
                            ZStack {
                                ...
                                DialogBubble(width: geo.size.width * 0.25, height: geo.size.height * 0.25, fontSize: 24, text: "Halo, Rahmat! Aku Kepi.", playVoiceover: !voiceoverPlayed)
                    ...
                    SceneWithCaptionView(
                        ...
                        captionVoiceover: .screen4, childObject: AnyView(
                            ZStack {
                                ...
                                DialogBubble(width: geo.size.width * 0.2, height: geo.size.height * 0.2, fontSize: 24, text: "Tolong Kepi!", flipped: true, playVoiceover: !voiceoverPlayed)
