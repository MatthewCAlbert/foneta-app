...
let mainStoryLane = LaneManager([
    ...
    LaneItem(
        id: "3",
        body: LaneWrapperView(childView: AnyView(MiniOneStoryView(page: 3, nextScreenId: "mini-1-game")))
    ),
    LaneItem(
        id: "mini-1-game",
        body: LaneWrapperView(childView: AnyView(MiniGameOneView(nextScreenId: "mini-1-end")))
    ),
    LaneItem(
        id: "mini-1-end",
    ...
    LaneItem(
        id: "5",
        body: LaneWrapperView(childView: AnyView(MiniTwoStoryView(page: 2, nextScreenId: "mini-2-game")))
    ),
    LaneItem(
        id: "mini-2-game",
        body: LaneWrapperView(childView: AnyView(Mini2EntryView(nextScreenId: "mini-2-end")))
    ),
    LaneItem(
        id: "mini-2-end",
